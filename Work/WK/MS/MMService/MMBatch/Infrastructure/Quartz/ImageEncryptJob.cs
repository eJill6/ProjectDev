...
namespace MMBatch.Infrastructure.Quartz
{
    ...
    /// 將圖片加密的排程
    /// </summary>
    public class ImageEncryptJob : BaseJob
    {
        /// <summary>
        /// 開始時間
        /// </summary>
        ...
        /// 日誌
        /// </summary>
        private readonly ILogger<ImageEncryptJob> _logger = null;
        ...
        public ImageEncryptJob(IEnumerable<IMediaService> services,
            ILogger<ImageEncryptJob> logger)
        {
            _services = services;
            _logger = logger;
        }
        ...
        public override async Task Execute(IJobExecutionContext context)
        {
            ...
            if (!_isEncrypted)
            {
                _logger.LogInformation($"Begin Encrypt, From:{_begin}, To:{_end}");
