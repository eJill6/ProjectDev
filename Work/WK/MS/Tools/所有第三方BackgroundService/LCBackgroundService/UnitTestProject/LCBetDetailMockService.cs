...
namespace UnitTestProject
{
    public class LCBetDetailMockService : LCBetDetailMSLService
    {
        protected override BetLogResponseInfo GetRemoteBetDetailApiResult(LCApiParamModel apiParam)
        {
            ...
            string agentID = ConfigUtilService.Get("AgentID").Trim();
            string linecode = ConfigUtilService.Get("LCLinecode").Trim();
            ...
            TestUtil.DoPlayerJobs(
                ...
                job: (playerId, betId) =>
                {
                    ...
                    {
                        Accounts = lcUserHeader + playerId,
