...
namespace ProductTransferService
{
    ...
    {
        protected override PlatformProduct Product => PlatformProduct.BTIS;
        ...
        protected override BaseReturnDataModel<List<BTISBetLog>> ConvertToBetLogs(string apiResult)
        {
            ...
            else if (!betHistoryResponse.IsSuccess)
            {
                ...
                {
                    errorMsg = dataErrorCode.Message;
                }
        ...
        protected override List<InsertTPGameProfitlossParam> ConvertToTPGameProfitloss(Dictionary<string, int> userMap, List<BTISBetLog> betLogs)
        {
