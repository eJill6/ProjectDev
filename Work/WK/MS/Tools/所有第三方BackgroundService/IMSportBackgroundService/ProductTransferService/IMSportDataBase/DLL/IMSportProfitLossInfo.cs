using IMSportDataBase.DBUtility;
...
{
    public class IMSportProfitLossInfo : OldProfitLossInfo, IIMSportOldSaveProfitLossInfo
    {
        ...
        public string SelectLastSearchTime()
        {
            ...
            {
                LogUtilService.Info("查询 LastSearchTime 时错误：错误信息:" + ex.Message + ",错误堆栈：" + ex.StackTrace);
            }
