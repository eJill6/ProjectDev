...
namespace IMSportDataBase.Model
{
    ...
    public class SingleBetInfo : BasicBetInfo
    {
        public static readonly string s_cashOutTradeStatus = "Sold";
        ...
        /// 細節內容
        /// </summary>
        public List<DetailItem> DetailItems { get; internal set; }

        public string DetailItemsJson => DetailItems.ToJsonString();
    }
