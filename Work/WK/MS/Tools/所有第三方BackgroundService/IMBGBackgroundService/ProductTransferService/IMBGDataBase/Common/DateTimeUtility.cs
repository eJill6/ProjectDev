...
namespace ProductTransferService.IMBGDataBase.Common
{
    ...
    public class DateTimeUtility
    {
        ...
        #endregion Convert Unix timestamp to DateTime
        ...
        #endregion 取得和目前系統時間差 DateDiff (系統時間 - 要比較的時間)

        #endregion DateTime 時間比較
    }
}