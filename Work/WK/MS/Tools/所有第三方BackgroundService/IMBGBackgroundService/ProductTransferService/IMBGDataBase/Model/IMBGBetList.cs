...
namespace ProductTransferService.IMBGDataBase.Model
{
    ...
    public class IMBGBetLogViewModel : BaseRemoteBetLog
    {
        public IMBGBetLog IMBGBetLog { get; set; }

        public override string KeyId => IMBGBetLog.Id.ToString();

        public override string TPGameAccount => IMBGBetLog.UserCode;
    }
}