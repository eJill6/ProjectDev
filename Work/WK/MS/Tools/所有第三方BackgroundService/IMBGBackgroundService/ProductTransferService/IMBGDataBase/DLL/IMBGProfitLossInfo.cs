using ProductTransferService.IMBGDataBase.DBUtility;
...
{
    public class IMBGProfitLossInfo : OldProfitLossInfo, IIMBGOldSaveProfitLossInfo
    {
        ...
        /// 保存在本地数据库
        /// </summary>
        public void SaveDataToTarget(List<IMBGBetLogViewModel> betViewModels)
        {
