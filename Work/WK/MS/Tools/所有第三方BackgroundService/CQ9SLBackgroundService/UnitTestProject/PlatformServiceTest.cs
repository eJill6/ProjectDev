...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest : BaseUnitTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.CQ9SL;
        ...
        public void TestLaunchMobileGameMethod()
        {
            var model = new ForwardGameUrlParam
            {
                ...
                IpAddress = "127.0.0.1",
                IsMobile = true,
                LoginInfo = new LoginInfo { RemoteCode = "7" }
            };
        ...
        {
            string lastSearchToken = DateTimeOffset.Parse("2024-01-04T00:47:36.2457409-04:00").UtcDateTime.ToUnixOfTime().ToString();
            BaseReturnDataModel<RequestAndResponse> returnModel = _tpGameApiService.Value.GetRemoteBetLog(lastSearchToken);
        }
