...
namespace IMPPDataBase.DLL
{
    public class UserDal
    {
        ...
        /// 转入转出失败时，回滚数据
        /// </summary>
        public static List<IMPPUserInfo> GetUserInfo()
        {
            List<IMPPUserInfo> userInfos = new List<IMPPUserInfo>();
            ...
            string sql = @"SELECT   UserID ,
                                    ...
                                    AvailableScores ,
                                    FreezeScores
                            FROM    dbo.IMPPUserInfo WITH ( NOLOCK );";
            ...
            if (ds.Tables != null && ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    IMPPUserInfo userinfo = new IMPPUserInfo();
        ...
        public static bool UpdateAvailableScores(IMPPUserInfo userInfo)
        {
            string sql = @"
                UPDATE dbo.IMPPUserInfo 
