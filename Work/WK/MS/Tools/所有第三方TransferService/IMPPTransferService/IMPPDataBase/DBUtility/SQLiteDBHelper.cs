...
namespace IMPPDataBase.DBUtility
{
    public static class SQLiteDBHelper
    {
        ...
        /// <summary>
        /// 创建IMPPProfitLossInfo表
        /// </summary>
        /// <param name="dbPath">要创建的SQLite数据库文件路径</param>
        public static void CreateIMPPProfitLossInfo(string dbPath)
        {
            string sql = @"
                CREATE TABLE IMPPProfitLossInfo(
                    ...
                    ExternalRoundId NVARCHAR(50) NULL,
                    PlayerId NVARCHAR(50) NULL,
                    ProviderPlayerId NVARCHAR(50) NULL,
                    BetAmount REAL NULL,
                    WinLoss REAL NULL,
                    ProgressiveBet REAL NULL,
                    ProgressiveWin REAL NULL,
                    Bonus REAL NULL,
            ...
            sql = "CREATE UNIQUE INDEX IMPPProfitLossInfo_idx_RoundId ON IMPPProfitLossInfo(RoundId ASC);";
