...
{
    public class Transfer : OldBaseTPGameApiService<IMPPApiParamModel>
    {
        ...
        protected override BaseReturnModel GetRemoteOrderStatus(IMPPApiParamModel apiParam)
        {
        ...
        public override BaseReturnDataModel<UserScore> GetRemoteUserScore(IMPPApiParamModel apiParam)
        {
            IMPPBalanceInfo balanceInfo = GetBalance(apiParam);
        ...
        protected override BaseReturnModel SaveTransferOrderSuccess(OldTPGameOrderParam<IMPPApiParamModel> oldTPGameOrderParam, UserScore userScore)
        {
        ...
        protected override BaseReturnModel SaveTransferOrderFail(OldTPGameOrderParam<IMPPApiParamModel> oldTPGameOrderParam, string errorMsg)
        {
        ...
        protected override BaseReturnDataModel<TPGameTransferReturnResult> GetTransferReturnModel(OldTPGameOrderParam<IMPPApiParamModel> oldTPGameOrderParam)
        {
            IMPPApiParamModel model = oldTPGameOrderParam.ApiParam;
        ...
        //    try
        //    {
        //        IMPPApiParamModel model = (IMPPApiParamModel)obj;

        //        FundTransferResult result = FundTransfer((IMPPApiParamModel)model);
        ...
        //                    if (rollbackResult.IsSuccess)
        //                    {
        //                        summary = "转账¥" + model.Amount + "到IMPP電子账户失败，请重试。";
        //                    }
        //                    else
        //                    {
        //                        summary = "转账¥" + model.Amount + "到IMPP電子账户失败，请联系客服。";
        //                    }
        //                }
        //                else
        //                {
        //                    summary = "从IMPP電子账户提款¥" + model.Amount + "失败，请重试。";
        //                }
        ...
        /// <returns></returns>
        private FundTransferResult FundTransferWithRetry(IMPPApiParamModel model, ref string apiResult)
        {
        ...
        ///// </summary>
        ///// <param name="model"></param>
        //public void CheckFundTransfer(IMPPApiParamModel model)
        //{
        //    int tryCount = 0;
        ...
        //        //確認訂單
        //        var result = GetOrderStatusByApi(model);
        ...
        //                if (model.ActType == ApiAction.Recharge)
        //                {
        //                    summary = "您成功转账 ¥" + model.Amount + " 到IMPP電子账户";
        //                }
        //                else
        //                {
        //                    summary = "您成功从IMPP電子账户提款 ¥" + model.Amount;
        //                }
        ...
        //            try
        //            {
        //                dataResultStr = JsonConvert.SerializeObject(result);
        //            }
        //            catch (Exception ex)
        //            {
        //            }
        ...
        /// </summary>
        /// <returns></returns>
        public static IMPPBalanceInfo GetBalance(IMPPApiParamModel model)
        {
            IMPPBalanceInfo result = new IMPPBalanceInfo();
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(apiResult))
                {
                    result = apiResult.Deserialize<IMPPBalanceInfo>();
                }
            }
            catch (Exception ex)
            {
                LogsManager.InfoToTelegram("用户" + model.PlayerId + "在 IMPP 平台获取余额失败，错误信息：" + ex.Message + "，堆栈信息：" + ex.StackTrace);
            }
        ...
        private ResultModel CycleTryTransferSuccess(string TransferID, string ActionType, int userId, decimal availableScores, decimal freezeScores)
        {
            ...
            while (tryCount < 5)
            {
                ...
                try
                {
                    result.IsSuccess = new IMPPDataBase.DLL.IMPPMoneyTransferService()
                        .IMPPTransferSuccess(TransferID, ActionType, userId, availableScores, freezeScores);
        ...
        private ResultModel CycleTryTransferRollback(string TransferID, string ActionType, string Msg)
        {
            ...
            while (tryCount < 5)
            {
                ...
                try
                {
                    ...
                    result.IsSuccess = new IMPPDataBase.DLL.IMPPMoneyTransferService().IMPPTransferRollback(TransferID, ActionType, Msg, isRollback);
        ...
        /// 更新棋牌總餘額
        /// </summary>
        public void RefreshAvailableScores(IMPPApiParamModel model)
        {
            var userInfos = new List<IMPPUserInfo>();
            try
            {
