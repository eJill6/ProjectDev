...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.IMKY;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.IMKYTransferService,
        ...
        {
            BaseReturnDataModel<RequestAndResponse> returnModel = _tpGameApiService.GetRemoteBetLog("1666779328000");
        }
        ...
        {
            ReflectUtilNF.RunInteractive(new IMKYTransferScheduleMockService());
        }
    }
}