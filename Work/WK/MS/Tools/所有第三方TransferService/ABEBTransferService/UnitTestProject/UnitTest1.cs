...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            Application = JxApplication.ABEBTransferService,
        ...
        {
            ReflectUtilNF.RunInteractive(new ProductTransferScheduleMockService());
        }

        [TestMethod]
        public void TestTransferReturnDataModel()
        {
            BaseReturnDataModel<RequestAndResponse> result = _tpGameApiService.GetRemoteBetLog("1614322800000");
        }
    }
}