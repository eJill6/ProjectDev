...
namespace IMBGDataBase.DBUtility
{
    public static class SQLiteDBHelper
    {
        ...
        /// <summary>
        /// 创建IMBGProfitLossInfo表
        /// </summary>
        /// <param name="dbPath">要创建的SQLite数据库文件路径</param>
        public static void CreateIMBGProfitLossInfo(string dbPath)
        {
            string sql = @"
                CREATE TABLE IMBGProfitLossInfo(
            ...
            sql = "CREATE UNIQUE INDEX IMBGProfitLossInfo_idx_Id ON IMBGProfitLossInfo(Id ASC);";
