...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.PMBG;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.PMBGTransferService,
        ...
        {
            ReflectUtilNF.RunInteractive(new PMBGTransferScheduleMockService());
        }
    }
}