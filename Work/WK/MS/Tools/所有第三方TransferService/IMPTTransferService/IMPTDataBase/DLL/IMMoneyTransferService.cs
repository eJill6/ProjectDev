...
namespace IMPTDataBase.DLL
{
    public class IMMoneyTransferService
    {
        ...
        public List<Model.IMMoneyInInfo> SearchMoneyIn()
        {
            ...
            DataSet ds = DbHelperSQL.RunProcedure("Pro_SearchIMPTMoneyInInfo", parameters, "tab");
            if (ds != null)
            {
                if (ds.Tables != null)
                {
        ...
        {
            SqlParameter[] parameters = { };
            DataSet ds = DbHelperSQL.RunProcedure("Pro_SearchIMPTMoneyOutInfo", parameters, "tab");
            if (ds != null)
            {
                if (ds.Tables != null)
                {
        ...
        public bool IMTransferSuccess(string TransferID, string ActionType, int userId, decimal availableScores, decimal freezeScores)
        {
            ...
            DataSet dt = DbHelperSQL.RunProcedure("Pro_IMPTTransferSuccess", parameters, "tab");
        ...
        public bool IMTransferRollback(string TransferID, string ActionType, string Msg, bool RollBack)
        {
            ...
            DataSet dt = DbHelperSQL.RunProcedure("Pro_IMPTTransferRollback", parameters, "tab");
