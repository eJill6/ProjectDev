...
namespace IMPTUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.IMPT;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.IMPTTransferService,
        ...
        {
            IMPTProfitLossInfo.ExistsOrder("1");
            IMPTProfitLossInfo.SaveDataToLocal(new IMPTDataBase.Model.SingleBetInfo
            {
        ...
        public void TestSetLocalScores()
        {
            ...
            var transfer = new Transfer(new EnvironmentUser() { Application = JxApplication.IMPTTransferService, LoginUser = new BasicUserInfo() }, DbConnectionTypes.Master);
