...
namespace UnitTestProject
{
    public class MockDataUtil
    {
        ...
        public static DetailRequestAndResponse GetRemoteTransferApiResult(bool isMoneyIn, string tpGameAccount, BaseTPGameMoneyInfo tpGameMoneyInfo)
        {
            ...
            {
                MerchantCode = IMVRAppSettings.Instance.MerchantCode,
                ProductWallet = IMVRAppSettings.Instance.ProductWallet,
            ...
            {
                Url = $"http://test.transfer.{PlatformProduct.IMVR.Value}",
