...
namespace IMSportUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.IMSport;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.IMSportTransferService,
        ...
        public void TestTransferMockService()
        {
            ...
            {
                new IMSportTransferMockService()
            };
        ...
        {
            IMSportProfitLossInfo.ExistsOrder("1");
            IMSportProfitLossInfo.SaveDataToLocal(new IMSportsbookDataBase.Model.SingleBetInfo()
            {
        ...
        public void TestSetLocalScores()
        {
            ...
            var transfer = new Transfer(new EnvironmentUser() { Application = JxApplication.IMSportTransferService, LoginUser = new BasicUserInfo() }, DbConnectionTypes.Master);
