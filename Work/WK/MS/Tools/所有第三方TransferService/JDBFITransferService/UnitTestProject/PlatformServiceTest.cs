...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.JDBFI;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.JDBFITransferService,
        ...
        public void TestCheckUserScoreMethod()
        {
            ...
            BaseReturnModel returnModel = _tpGameApiService.GetRemoteUserScore(invocationUserParam, false);
        }
        ...
        public void TestBetLogMethod()
        {
            try
            {
                BaseReturnDataModel<RequestAndResponse> returnModel = _tpGameApiService.GetRemoteBetLog("2023-01-25 00:20:36.000");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            ReflectUtilNF.RunInteractive(new JDBFITransferScheduleMockService());
        }
    }
}