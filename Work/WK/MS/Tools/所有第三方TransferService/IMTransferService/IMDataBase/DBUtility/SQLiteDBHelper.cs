...
namespace IMDataBase.DBUtility
{
    public static class SQLiteDBHelper
    {
        ...
        public static void CreateIMProfitLossInfo(string dbPath)
        {
            string sql = @"
                CREATE TABLE IMProfitLossInfo(
                    ...
                    SettlementDateTime NVARCHAR(100) NULL,
            ...
            sql = "CREATE UNIQUE INDEX IMProfitLossInfo_idx_BetId ON IMProfitLossInfo(BetId ASC);";
        ...
        public static void AddColumn(string dbPath, string tableName, string columnName, string columnDataType, bool nullable)
        {
