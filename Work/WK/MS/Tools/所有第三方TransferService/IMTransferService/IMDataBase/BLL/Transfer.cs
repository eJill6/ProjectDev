...
{
    public class Transfer : OldBaseTPGameApiService<IMApiParamModel>
    {
        ...
        protected override BaseReturnModel GetRemoteOrderStatus(IMApiParamModel apiParam)
        {
        ...
        public override BaseReturnDataModel<UserScore> GetRemoteUserScore(IMApiParamModel apiParam)
        {
        ...
        protected override BaseReturnModel SaveTransferOrderSuccess(OldTPGameOrderParam<IMApiParamModel> oldTPGameOrderParam, UserScore userScore)
        {
        ...
        protected override BaseReturnModel SaveTransferOrderFail(OldTPGameOrderParam<IMApiParamModel> oldTPGameOrderParam, string errorMsg)
        {
        ...
        protected override BaseReturnDataModel<TPGameTransferReturnResult> GetTransferReturnModel(OldTPGameOrderParam<IMApiParamModel> oldTPGameOrderParam)
        {
            IMApiParamModel model = oldTPGameOrderParam.ApiParam;
        ...
        //    try
        //    {
        //        IMApiParamModel model = (IMApiParamModel)obj;

        //        FundTransferResult result = FundTransfer((IMApiParamModel)model);
        ...
        //                    if (rollbackResult.IsSuccess)
        //                    {
        //                        summary = "转账¥" + model.Amount + "到电竞账户失败，请重试。";
        //                    }
        //                    else
        //                    {
        //                        summary = "转账¥" + model.Amount + "到电竞账户失败，请联系客服。";
        //                    }
        //                }
        //                else
        //                {
        //                    summary = "从电竞账户提款¥" + model.Amount + "失败，请重试。";
        //                }
        ...
        /// <returns></returns>
        private FundTransferResult FundTransferWithRetry(IMApiParamModel model, ref string apiResult)
        {
        ...
        ///// </summary>
        ///// <param name="model"></param>
        //public void CheckFundTransfer(IMApiParamModel model)
        //{
        //    int tryCount = 0;
        ...
        //                if (model.ActType == ApiAction.Recharge)
        //                {
        //                    summary = "您成功转账 ¥" + model.Amount + " 到电竞账户";
        //                }
        //                else
        //                {
        //                    summary = "您成功从电竞账户提款 ¥" + model.Amount;
        //                }
        ...
        /// </summary>
        /// <returns></returns>
        public static IMBalanceInfo GetBalance(IMApiParamModel model)
        {
            ...
            {
                LogsManager.InfoToTelegram("用户" + model.PlayerId + "在 IM 平台获取余额失败，错误信息：" + ex.Message + "，堆栈信息：" + ex.StackTrace);
            }
        ...
        private ResultModel CycleTryTransferSuccess(string TransferID, string ActionType, int userId, decimal availableScores, decimal freezeScores)
        {
            ...
            while (tryCount < 5)
            {
                ...
                try
                {
                    result.IsSuccess = new IMDataBase.DLL.IMMoneyTransferService()
        ...
        private ResultModel CycleTryTransferRollback(string TransferID, string ActionType, string Msg)
        {
            ...
            while (tryCount < 5)
            {
                ...
                try
                {
                    ...
                    result.IsSuccess = new IMDataBase.DLL.IMMoneyTransferService().IMTransferRollback(TransferID, ActionType, Msg, isRollback);
        ...
        /// 更新棋牌總餘額
        /// </summary>
        public void RefreshAvailableScores(IMApiParamModel model)
        {
