...
namespace IMUnitTest
{
    ...
    public class UnitTest1
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.IM;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.IMTransferService,
        ...
        {
            IMProfitLossInfo.ExistsOrder("1");
            IMProfitLossInfo.SaveDataToLocal(new IMDataBase.Model.SingleBetInfo
            {
