...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.OBSP;
        ...
        {
            ReflectUtilNF.RunInteractive(new OBSPTransferScheduleMockService());
        }
        ...
        public void TestDataApiRate()
        {
            for (int i = 1; i <= 30; i++)
            {
                ...
                //var baseReturnDataModel = _tpGameApiService.GetRemoteBetLogApiResult(null);
                //Assert.IsTrue(baseReturnDataModel.IsSuccess);

                //string[] responseContents = baseReturnDataModel.DataModel.ResponseContent.Deserialize<string[]>();
                ...
                //    Assert.IsTrue(queryBetListResponse.IsSuccess);
                //}
            }
        }
    }
