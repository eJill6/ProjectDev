...
namespace ProductTransferService
{
    public partial class ProductTransferScheduleService : BaseTransferScheduleService<OBSPBetLog>
    {
        ...
        public override JxApplication Application => JxApplication.OBSPTransferService;
        ...
        protected override List<InsertTPGameProfitlossParam> ConvertToTPGameProfitloss(List<OBSPBetLog> betLogs)
        {
        ...
        protected override void DoSaveBetLogToPlatform(List<OBSPBetLog> betLogs)
        {
