...
namespace ProductTransferService
{
    public partial class ProductTransferScheduleService : BaseTransferScheduleService<FYESBetLog>
    {
        ...
        public override JxApplication Application => JxApplication.FYESTransferService;
        ...
        protected override List<InsertTPGameProfitlossParam> ConvertToTPGameProfitloss(List<FYESBetLog> betLogs)
        {
