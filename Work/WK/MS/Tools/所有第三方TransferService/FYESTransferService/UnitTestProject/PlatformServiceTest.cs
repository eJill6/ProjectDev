...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.FYES;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.FYESTransferService,
        ...
        {
            ReflectUtilNF.RunInteractive(new FYESTransferScheduleMockService());
        }
    }
}