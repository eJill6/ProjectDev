...
namespace IMeBetDataBase.DLL
{
    public class UserDal
    {
        ...
        /// 转入转出失败时，回滚数据
        /// </summary>
        public static List<IMeBetUserInfo> GetUserInfo()
        {
            List<IMeBetUserInfo> userInfos = new List<IMeBetUserInfo>();
            ...
            string sql = @"SELECT   UserID ,
                                    ...
                                    AvailableScores ,
                                    FreezeScores
                            FROM    dbo.IMeBetUserInfo WITH ( NOLOCK );";
            ...
            if (ds.Tables != null && ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    IMeBetUserInfo userinfo = new IMeBetUserInfo();
        ...
        public static bool UpdateAvailableScores(IMeBetUserInfo userInfo)
        {
            string sql = @"
                UPDATE dbo.IMeBetUserInfo 
