...
namespace UnitTestProject
{
    ...
    public class PlatformServiceTest
    {
        ...
        private readonly PlatformProduct _product = PlatformProduct.OBEB;

        private readonly EnvironmentUser _environmentUser = new EnvironmentUser()
        {
            Application = JxApplication.OBEBTransferService,
        ...
        {
            ReflectUtilNF.RunInteractive(new OBEBTransferScheduleMockService());
        }
    }
}