...
namespace BatchService.Job
{
    ...
    {
        private readonly IStoredProcedureErrorLogService _sqlJobErrorLogService;
        ...
        private List<string> GetProErrorLogsNoticeMessage(ref int logId, InlodbType inlodbType)
        {
            ...
            if (logId == 0)
            {
                Pro_ErrorLogs proErrorLog = _sqlJobErrorLogService.GetProErrorLogs(inlodbType);
            ...
            {
                List<Pro_ErrorLogs> proErrorLogsList = _sqlJobErrorLogService.GetProErrorLogsList(inlodbType, logId);
        ...
        private List<string> GetJobRunLogNoticeMessage()
        {
            ...
            List<JobRunLog> jobRunLogList = _sqlJobErrorLogService.GetJobRunLogStatus(_lastJobRunLogStartTime);
