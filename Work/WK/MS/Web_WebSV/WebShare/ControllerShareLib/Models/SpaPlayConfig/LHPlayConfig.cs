using JxLottery.Models.Lottery.PlayTypeRadio.LH;
...
/// 設定龍虎玩法
/// </summary>
public class LHPlayConfig : ISpaPlayConfig
{
    private IList<PlayMode<PlayTypeInfo>> playModes;

    public int GameTypeId => (int)JxLottery.Models.Lottery.GameTypeId.LH;
                        ...
                        new PlayTypeInfo()
                        {
                            ...
                            PlayTypeRadioInfos = new List<PlayTypeRadioInfo>()
                            {
                                new PlayTypeRadioInfo()
                                {
                                    ...
                                    Fields = JxLottery.Services.BonusService.Calculators.LH.Const
