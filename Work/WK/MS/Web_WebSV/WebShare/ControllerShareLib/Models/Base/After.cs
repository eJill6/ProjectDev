...
namespace ControllerShareLib.Models.Base
{
    ...
    public class After
    {
        ...
        /// 追号清单
        /// </returns>
        private static List<string> CreatePeriodsWithDateTimeFormat(int totalIssueCount, string currentIssueNo, int diffMinute, string issueFormat)
        {
        ...
        /// 追号清单
        /// </returns>
        private static List<string> CreatePeriodsWithDateTimeFormatAndSNO(int totalIssueCount,
        ...
        /// <returns></returns>
        public static List<string> CreatePeriods(int num, KIND k, string currentIssueNo, DateTime time, int lotteryType)
        {
        ...
        public static List<ZhStrct> ProfitRate(int num, double Pro, double betmoney, double singBetMoney, double prize, int m)
        {
        ...
        /// <returns></returns>
        public static List<ZhStrct> ProfitRate(int num, double singBetMoney, int m)
        {
            List<ZhStrct> zh = new List<ZhStrct>();
            for (int i = 0; i < num; i++)
            {
        ...
        /// <returns></returns>
        public static List<ZhStrct> ProfitRate(int num, int Pre, double singBetMoney, int m)
        {
            int checkNum = 0;
            List<ZhStrct> zh = new List<ZhStrct>();
            for (int i = 0; i < num; i++)
