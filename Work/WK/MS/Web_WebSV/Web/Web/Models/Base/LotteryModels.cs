...
namespace Web.Models.Base
{
    public class LotteryDrawResultModel
    {
        ...
        {
            this.LatestTime = new LotteryModel();
            this.CurrentTime = new LotteryModel();
        }
    }
    ...
    public class SummaryModel
    {
        public SummaryModel()
        {
            this.LotteryList = new List<LotteryModel>();
            this.OrderList = new List<OrderDetailsModel>();
        }
    ...
    public class TodaySummaryModel : SummaryModel
    {
        public TodaySummaryModel()
            : base()
        {
            this.SummaryList = new List<PlaySummaryModel>();
        }
    ...
    public class PK10SummaryModel : SummaryModel
    {
        public PK10SummaryModel()
            : base()
        {
            this.LongQueueList = new List<LongQueue>();
        }
    ...
    public class PlayInfoModel
    {
        ...
        {
            this.PlayTypeRadios = new List<PlayTypeRadio>();
            this.PlayOddsModel = new List<PlayOddsModel>();
        }
    }
    ...
    public class AfterDetailsModel
    {
        ...
        {
            this.AfterDetails = new List<AfterDetailModel>();
        }
    }
