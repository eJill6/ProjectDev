    ...
    <div class="main_container_flex">
      ...
      <div class="flex_height" v-if="!isSuccessfullyOpened">
        <div class="overflow no_scrollbar">
          <ul
            class="vip_top_area no_scrollbar"
            ref="list"
          ...
          >
            <li class="vip_card silver">
              <div class="vip_tag">
                <img src="@/assets/images/vip/vip_card_tag.svg" />
              </div>
              <div class="vip_state">
                <img src="@/assets/images/vip/vip_card_state.svg" />
              </div>
              <div
              ...
              >
                <div>
                  <div
                    :class="
                      hasVipCard(VipType.Silver)
                        ? 'vip_title_opened'
                        : 'vip_title'
                    "
                  >
                    <img src="@/assets/images/vip/vip_card_title.svg" />
                  </div>
                  <div class="vip_price_col" v-if="!hasVipCard(VipType.Silver)">
                ...
                <div class="vip_img">
                  <img src="@/assets/images/vip/vip_card_crown.png" />
                </div>
              </div>
            </li>
            <li class="vip_card gold">
              <div class="vip_tag">
                <img src="@/assets/images/vip/vip_card_gold_tag.svg" />
              </div>
              <div class="vip_state">
                <img src="@/assets/images/vip/vip_card_gold_state.svg" />
              </div>
              <div
                class="vip_card_content"
              ...
              >
                <div>
                  <div
                    ...
                    "
                  >
                    <img src="@/assets/images/vip/vip_card_gold_title.svg" />
                  </div>
                ...
                <div class="vip_img">
                  <img src="@/assets/images/vip/vip_card_gold_crown.png" />
                </div>
              </div>
            </li>
          </ul>
          ...
          <div v-if="pageVipType === VipType.Silver" class="vip_content_list">
            <div class="bg_vip_content_frame">
              <img src="@/assets/images/vip/bg_vip_content_frame.png" />
            </div>
            <div class="vip_list_title">专属特权</div>
            <div class="vip_list_menu_frame">
              <div class="vip_list_menu">
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_unlock_free.svg" />
                  <div>免费解锁帖子</div>
                </div>
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_discount.svg" />
                  <div>解锁帖子折扣</div>
                </div>
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_mark.svg" />
                  <div>VIP身份徽章</div>
                </div>
              </div>
              <div class="vip_list_menu">
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_post.svg" />
                  <div>发布广场贴</div>
                </div>
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_gift.svg" />
                  <div>收益提现权限</div>
                </div>
              </div>
            </div>
          ...
          <div v-else-if="pageVipType == VipType.Gold" class="vip_content_list">
            ...
            <div class="vip_list_menu_frame">
              ...
              <div class="vip_list_menu">
                ...
                <div class="vip_list_btn">
                  <img src="@/assets/images/vip/ic_vip_rebate.svg" />
                  <div>预约金折扣</div>
                </div>
              </div>
            </div>
            <div class="vip_menu_detail">
              <div class="">
                <div>1.每天赠送15次免费解锁次数（广场区和担保区）</div>
                <div>2.广场区、担保区解锁帖子7折</div>
      ...
      <div class="vip_btn" v-if="!isOpened && !isSuccessfullyOpened" @click="toPay">
...
import api from "@/api";
import { BuySuccessModel, VipCardModel, WalletModel } from "@/models";
...
export default defineComponent({
  ...
  methods: {
    ...
    toPay() {
      this.showToPayDialog(
        this.vipCards[this.currentIndex],
        async (isSuccessModel) => {
  ...
  computed: {
    ...
    isOpened() {
      ...
      return vipCards.filter((e) => e.type === this.pageVipType).length;
    },
