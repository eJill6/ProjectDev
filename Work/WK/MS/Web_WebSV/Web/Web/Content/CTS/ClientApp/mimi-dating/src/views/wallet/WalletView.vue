              ...
              <div class="wallet_card mb_0">
                ...
                <div class="wallet_box">
                  <div class="wallet_content wallet_content_flex">
                    ...
                    <div class="wallet_price wallet_text_small">
                      {{ walletInfo.freezeIncome }}
                    </div>
                  </div>
                  <div class="wallet_content wallet_content_flex">
              ...
              <div class="wallet_list_section">
                <div class="wallet_list_item" @click="navigateToProfitDetail">
                  <div class="wallet_list_box">
                    <div>
                      <img src="@/assets/images/wallet/ic_wallet_shouyi.svg" />
                    </div>
                ...
                <div class="wallet_list_item" @click="navigateToPaymentHistory">
                  <div class="wallet_list_box">
                    <div>
                      <img src="@/assets/images/wallet/ic_wallet_xiaofei.svg" />
                    </div>
                ...
                <div class="wallet_list_item" @click="goExchangerecordUrl">
                  <div class="wallet_list_box">
                    <div>
                      <img src="@/assets/images/wallet/ic_wallet_duihuan.svg" />
                    </div>
                ...
                <div class="wallet_list_item" @click="goDwReportUrl">
                  <div class="wallet_list_box">
                    <div>
                      <img src="@/assets/images/wallet/ic_wallet_chongti.svg" />
                    </div>
