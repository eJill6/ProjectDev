    ...
    <div class="overflow no_scrollbar post bg_post_d">
      ...
      <div class="padding_basic">
        <div class="introduce_title">
          <img src="@/assets/images/post/pic_title_d_1.png" alt="" />
        </div>
        <div class="introduce_text" v-html="messages.what"></div>
        <div class="introduce_title">
          <img src="@/assets/images/post/pic_title_d_2.png" alt="" />
        </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    async getWhatIs() {
      try {
        this.messages = await api.getWhatIs(PostType.Square, AdvertisingContentType.TalentScout);
      } catch (error) {
        toast(error);
      }
    },
