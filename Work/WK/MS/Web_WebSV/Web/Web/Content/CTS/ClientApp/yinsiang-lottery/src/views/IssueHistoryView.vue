<template>
  <div class="h-100 second-dark-content rounded-main">
    ...
    <div class="h-with-title overflow-scroll-y no-scrollbar" @scroll="onScroll" ref="scrollContainer">
      <div :style="{'padding-top': virtualScroll.paddingTop + 'px','padding-bottom': virtualScroll.paddingBottom + 'px',}">
        <component :is="issueHistoryComponentName" :list="virtualScroll.list"></component>
      </div>
    </div>
  </div>
</template>
