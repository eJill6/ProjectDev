<template>
  <div class="d-flex">
    <div class="lottery_ball ml-2" v-for="n in drawNumbers">
      {{ parseInt(n) }}
    </div>
  </div>
  <div class="d-flex justify-content-end mt-2">
    ...
    <div
      class="d-flex justify-content-center align-items-center rounded-1 fs-2 ml-2 win-type bg-white text-black"      
    >
      {{ longHuHuo }}
    </div>
  </div>
...
export default defineComponent({
  ...
  computed: {
    ...
    longHuHuo() {
      return this.getLongHuHuo(this.drawNumbers);
    },
    daXiaoClassName() {
