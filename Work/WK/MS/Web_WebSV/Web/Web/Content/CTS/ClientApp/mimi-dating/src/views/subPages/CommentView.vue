            ...
            <div class="sheet_main" @click="showCityPicker">
              ...
              <div class="content content_right">
                ...
                <!-- <form class="form_full">
                  <input
                    class="input_style"
                    placeholder="请输入您体验所在的位置"
                    v-model="showCityName"
                  />
                </form> -->
              </div>
            </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    async getEditData() {
      ...
      try {
        ...
        this.setImageList(this.commentInfo.photoSource, SourceType.Comment);
      } catch (e) {
        toast(e);
      } finally {
        this.$store.commit(MutationType.SetIsLoading, false);
  ...
  computed: {
    ...
    commentId() {
      const id = this.$route.params.commentId as string;
