<template>
  <div class="game_up end">
    <div class="header_second" :class="{ end: isAddEndClass}">
      ...
      <div class="right">
        <div class="tab default" @click="navigateToRecentIssueHistory">
          <div class="tab_icon">
        ...
        <div class="btn" @click="navigateToOrderHistory">
          <AssetImage src="@/assets/images/record/ic_more_betting.png" />
        </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    navigateToRecentIssueHistory() {
      this.$router.push({ name: "Bet_RecentIssueHistory" });
    },
  },
  computed: {
    logoType() {
