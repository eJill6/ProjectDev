...
export default defineComponent({
  ...
  methods: {
    getClass(fieldIndex: number, numberIndex: number) {
      ...
      return {
        red: numberIndex === 0 && !isActive,
        "red active": numberIndex === 0 && isActive,
        blue: numberIndex === 1 && !isActive,
        "blue active": numberIndex === 1 && isActive,
        green: numberIndex === 2 && !isActive,
        "green active": numberIndex === 2 && isActive,
      };
    },
