<template>
  <div class="announcement_style_1">
    <div class="announcement_content_1">
      <div class="text_area_outter">
        <div class="text_area">
          <div class="overflow no_scrollbar text" v-html="announcementContent">
          </div>
        </div>
      </div>
    ...
    <div class="announcement_close">
      <div @click="confirmEvent">
        <CdnImage
          src="@/assets/images/modal/ic_modal_close_announcement.svg"
          alt=""
        />
      </div>
    </div>
