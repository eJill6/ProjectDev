    ...
    <div class="lotteryrecord_item" v-for="item in list">
      <div class="lotteryrecord_row">
        ...
        <div class="kuaisan_item">
          <div class="omssc_num" v-for="n in item.drawNumbers">
            <AssetImage
              :src="`@/assets/images/result/omssc_ball_md_${parseInt(n)}.png`"
              alt=""
            />
          </div>
        </div>
        <div class="kuaisan_item">
          ...
          <div
            class="kuaisan_text win_type"
            :class="getLongHuHuoBackgroundClassName(item.drawNumbers)"
          >
