...
export default defineComponent({
  ...
  methods: {
    getClass(fieldIndex: number, numberIndex: number) {
      ...
      return {
        "bet-btn": fieldIndex === 1,
        "bet-btns1_XXL": fieldIndex === 0 && !isActive,
        "bet-btns1_XXL_active": fieldIndex === 0 && isActive,
        "bet-btns2_XXL": fieldIndex === 1 && !isActive,
        "bet-btns2_XXL_active": fieldIndex === 1 && isActive,
      };
    }
  },
});
