      ...
      <div class="flex_height bg_personal">
        ...
        <div class="overflow no_scrollbar post" v-if="!isSubmit">
          ...
          <div class="padding_basic_2 pt_0 pb_0">
            <div class="sheet_main full_width2">
              <div class="title title_full_width2 highlight highlight_color">投诉原因 <span class="title_red">*</span></div>
              <div class="content_full">
                <div class="radiobutton complaint">
                  <ul>
                    <li class="border_line" v-for="(n, index) in complaintReason">
                      <label>
                        <div class="text">{{ n }}</div>
                        <input type="radio" name="radio" :checked="isSelected(index)" @click="selectReason(index)" />
                        <span class="icon"><i>
                            <div class="dot"></div>
                          </i></span>
                      </label>
            ...
            <MediaSelection :title="selectTitle" :source="source" :media="media" :annotation="annotation" :max="maxCount" @show="showImageZoom">
            </MediaSelection>
            <div class="sheet_main full_width2 main_none">
              <div class="title title_full_width2 highlight highlight_color">详情描述<span class="title_red">*</span></div>
              <div class="content_full">
                <form class="textarea_full_width_style bg_raisinblack">
                  <textarea v-model="reportInfo.describe" class="no_scrollbar" name="" placeholder="请详细描述您所遇到的问题"
                    maxlength="150"></textarea>
                  <div class="notice_text">{{ textLength }}/150</div>
                </form>
                <div class="annotation_con">
        ...
        <div class="overflow no_scrollbar" v-else>
          <div class="padding_basic_2 full_height finish_page">
            ...
            <div class="bottom_btn" @click="navigateToPrevious">
              <div class="btn_default no_shadow">我知道了</div>
            </div>
          </div>
        </div>
      </div>
...
import { MediaSelection, ImageZoom } from "@/components";
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      annotation: "(请提供充足的截图证据，否则无法退款成功)"
    };
  },
  watch: {
