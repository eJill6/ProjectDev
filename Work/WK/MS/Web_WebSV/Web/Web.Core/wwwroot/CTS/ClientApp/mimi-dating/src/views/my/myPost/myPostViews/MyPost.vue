<template>
  ...
  <div class="me_filter hide_overflowx">
    <ul>
      <li
        :class="{ active: isStatusSelected(ReviewStatusType.None) }"
        @click="selectedStatus(ReviewStatusType.None)"
      >
      <div class="text">全部</div>
      </li>
      <li
        :class="{ active: isStatusSelected(ReviewStatusType.Approval) }"
        @click="selectedStatus(ReviewStatusType.Approval)"
      >
      <div class="text">展示中</div>
      </li>
      <li
        :class="{ active: isStatusSelected(ReviewStatusType.UnderReview) }"
        @click="selectedStatus(ReviewStatusType.UnderReview)"
      >
      <div class="text">审核中</div>
      </li>
      <li
        :class="{ active: isStatusSelected(ReviewStatusType.NotApproved) }"
        @click="selectedStatus(ReviewStatusType.NotApproved)"
      >
...
export default defineComponent({
  ...
  methods: {
    ...
    {
      return memo.length>10?memo.substring(0,10)+"...":memo;
    },
    sortCount() {
