<template>
  <div class="d-flex flex-direction-column justify-content-between h-100">
    <div class="pt-6 pb-6">
      <div
        class="d-flex justify-content-between align-items-center pl-7 pr-7 pr-5-sm pl-5-sm"
      >
        ...
        <div v-if="!isBigWinNumber">
          <WinNumbers></WinNumbers>
        </div>
        <BetSelectView v-else></BetSelectView>
      </div>
      <div
        v-if="!isBigWinNumber || isDisable"
        class="d-flex pl-7 pr-7 pr-5-sm pl-5-sm mt-4"
        :class="isDisable ? 'bet-menu-tab' : 'bet-menu-list'"
      >
      ...
      <WinNumbers v-if="isBigWinNumber && !isDisable"></WinNumbers>
...
import BetSelectView from "@/components/NewStyleGames/BetSelectView.vue";
import mesage from "@/message";
import { bigWinNumberList, defaultLotteryInfo } from "@/gameConfig";
