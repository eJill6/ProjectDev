...
var demoCrudEditSingleRowService = (function (_super) {
    __extends(demoCrudEditSingleRowService, _super);
    function demoCrudEditSingleRowService(param) {
        return _super.call(this, param) || this;
    }
    demoCrudEditSingleRowService.prototype.serializeFormData = function ($form) {
    ...
    return demoCrudEditSingleRowService;
