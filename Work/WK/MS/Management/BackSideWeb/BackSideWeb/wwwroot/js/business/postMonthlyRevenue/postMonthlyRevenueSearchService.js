...
var postMonthlyRevenueSearchService = (function (_super) {
    __extends(postMonthlyRevenueSearchService, _super);
    function postMonthlyRevenueSearchService(pageApiUrlSetting) {
    ...
    postMonthlyRevenueSearchService.prototype.setDefaultDateValues = function () {
    ...
    postMonthlyRevenueSearchService.prototype.getSubmitData = function () {
        var data = new postMonthlyRevenueSearchParam();
        data.beginTime = this.$startDate.val();
        data.endTime = this.$endDate.val();
        return data;
    };
    return postMonthlyRevenueSearchService;
