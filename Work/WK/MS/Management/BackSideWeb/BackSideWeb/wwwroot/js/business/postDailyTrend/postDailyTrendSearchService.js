...
var postDailyTrendSearchService = (function (_super) {
    __extends(postDailyTrendSearchService, _super);
    function postDailyTrendSearchService(pageApiUrlSetting) {
    ...
    postDailyTrendSearchService.prototype.getSubmitData = function () {
        var data = new postDailyTrendSearchParam();
        data.beginTime = this.$startDate.val();
        data.endTime = this.$endDate.val();
        return data;
    };
    return postDailyTrendSearchService;
