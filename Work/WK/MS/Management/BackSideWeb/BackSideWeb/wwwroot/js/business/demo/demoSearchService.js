...
var demoSearchService = (function (_super) {
    __extends(demoSearchService, _super);
    function demoSearchService(searchApiUrlSetting) {
    ...
    demoSearchService.prototype.getSubmitData = function () {
        var data = new demoSearchParam();
