...
var adminIncomeSearchService = (function (_super) {
    __extends(adminIncomeSearchService, _super);
    function adminIncomeSearchService(searchApiUrlSetting) {
    ...
    adminIncomeSearchService.prototype.getSubmitData = function () {
    ...
    return adminIncomeSearchService;
