...
var adminBookingSearchService = (function (_super) {
    __extends(adminBookingSearchService, _super);
    function adminBookingSearchService(searchApiUrlSetting) {
    ...
    adminBookingSearchService.prototype.getSubmitData = function () {
        var data = new adminBookingSearchParam();
    ...
    return adminBookingSearchService;
