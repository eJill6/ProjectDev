...
var dailyRevenueService = (function (_super) {
    __extends(dailyRevenueService, _super);
    function dailyRevenueService(pageApiUrlSetting) {
    ...
    dailyRevenueService.prototype.getSubmitData = function () {
        var data = new dailyRevenueSearchParam();
        data.beginTime = this.$startDate.val();
        data.endTime = this.$endDate.val();
        return data;
    };
    return dailyRevenueService;
