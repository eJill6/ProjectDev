...
var postMonthlyTrendSearchService = (function (_super) {
    __extends(postMonthlyTrendSearchService, _super);
    function postMonthlyTrendSearchService(pageApiUrlSetting) {
    ...
    postMonthlyTrendSearchService.prototype.setDefaultDateValues = function () {
    ...
    postMonthlyTrendSearchService.prototype.getSubmitData = function () {
        var data = new postMonthlyTrendSearchParam();
        data.beginTime = this.$startDate.val();
        data.endTime = this.$endDate.val();
        return data;
    };
    return postMonthlyTrendSearchService;
