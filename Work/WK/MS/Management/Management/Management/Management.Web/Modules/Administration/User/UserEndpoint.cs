...
namespace Management.Administration.Endpoints
{
    ...
    public class UserController : ServiceEndpoint
    {
        ...
        public BaseReturnDataModel<QrCodeViewModel> GetQRCode(GetQrCodeRequest request, [FromServices] IApiService apiService)
        {
            return apiService.GetQrCode(request);
        }
    }
}
