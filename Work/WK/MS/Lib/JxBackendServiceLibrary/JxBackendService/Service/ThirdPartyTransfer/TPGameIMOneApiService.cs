...
namespace JxBackendService.Service.ThirdPartyTransfer
{
    public abstract class TPGameIMOneApiService : BaseTPGameApiService
    {
        ...
        /// 檢查帳號
        /// </summary>
        protected BaseReturnDataModel<bool> CheckAccountExist(string tpGameAccount)
        {
        ...
        {
            string remoteGameCode = AppSetting.GameCode;
            ...
            IMLaunchGameRequestModel request = GetIMLaunchGameRequestModel(tpGameAccount, ipAddress, remoteGameCode);
