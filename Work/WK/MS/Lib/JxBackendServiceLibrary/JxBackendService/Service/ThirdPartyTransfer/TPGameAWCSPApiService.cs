...
namespace JxBackendService.Service.ThirdPartyTransfer
{
    public abstract class TPGameAWCSPApiService : BaseTPGameApiService
    {
        ...
        private static readonly int s_backSqliteSearchDateMinutes = 45;
        ...
        {
            string platformValue = ThirdPartySubGameCodes.GetSingle(loginInfo.GameCode).RemoteGameCode;
