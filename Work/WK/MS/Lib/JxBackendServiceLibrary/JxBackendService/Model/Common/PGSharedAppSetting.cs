namespace JxBackendService.Model.Common
{
    public class PGSLSharedAppSetting : SharedAppSettings
    {
        ...
        //public readonly string LaunchLobbyUrlPath = "/web-lobby/smartbot/"; //0422更新為 /web-lobby/tournament/open/
        public readonly string LaunchLobbyUrlPath = "/web-lobby/tournament/open/";

        public readonly string LaunchMobileLobbyUrlPath = "/lobby/index.html";
