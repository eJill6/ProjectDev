...
namespace JxBackendService.Repository.StoredProcedure
{
    public class FYESStoredProcedureRep : BaseTPGameStoredProcedureRep
    {
        ...
        protected override string MoneyInInfoTableName => "FYESMoneyInInfo";

        protected override string MoneyOutInfoTableName => "FYESMoneyOutInfo";
        ...
        protected override string AddProfitlossAndPlayInfoSpName => "Pro_AddFYESProfitLossAndPlayInfo";
