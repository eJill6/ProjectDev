...
namespace JxBackendService.Model.Enums.MiseOrder
{
    ...
    public class MiseOrderGameId : BaseStringValueModel<MiseOrderGameId>
    {
        ...
        public static readonly MiseOrderGameId OMKS = new MiseOrderGameId()
        {
            ...
            SubGameCodeType = ThirdPartySubGameCodes.LotteryOMKS,
        ...
        public static readonly MiseOrderGameId OMPK10 = new MiseOrderGameId()
        {
            ...
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryOMPK10,
        ...
        public static readonly MiseOrderGameId OMSSC = new MiseOrderGameId()
        {
            ...
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryOMSSC,
        ...
        public static readonly MiseOrderGameId OMLHC = new MiseOrderGameId()
        {
            ...
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryOMLHC,
            ResourcePropertyName = nameof(PlatformProductElement.OMLHC),
        };

        /// <summary>百人牛牛</summary>
        public static readonly MiseOrderGameId NUINUI = new MiseOrderGameId()
        {
            Value = "69",
            OrderSubType = MiseOrderSubType.NUINUI,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryNUINUI,
            ResourcePropertyName = nameof(PlatformProductElement.Lottery_NUINUI),
        };

        /// <summary>极速百家乐</summary>
        public static readonly MiseOrderGameId JSBaccarat = new MiseOrderGameId()
        {
            Value = "70",
            OrderSubType = MiseOrderSubType.JSBaccarat,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryJSBaccarat,
            ResourcePropertyName = nameof(PlatformProductElement.Lottery_JSBaccarat),
        };

        /// <summary>极速轮盘</summary>
        public static readonly MiseOrderGameId JSLP = new MiseOrderGameId()
        {
            Value = "71",
            OrderSubType = MiseOrderSubType.JSLP,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryJSLP,
            ResourcePropertyName = nameof(PlatformProductElement.Lottery_JSLP),
        };

        /// <summary>极速鱼虾蟹</summary>
        public static readonly MiseOrderGameId JSYXX = new MiseOrderGameId()
        {
            Value = "72",
            OrderSubType = MiseOrderSubType.JSYXX,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryJSYXX,
            ResourcePropertyName = nameof(PlatformProductElement.Lottery_JSYXX),
        };

        /// <summary>极速三公</summary>
        public static readonly MiseOrderGameId JSSG = new MiseOrderGameId()
        {
            Value = "73",
            OrderSubType = MiseOrderSubType.JSSG,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryJSSG,
            ResourcePropertyName = nameof(PlatformProductElement.Lottery_JSSG),
        };

        /// <summary>极速龙虎</summary>
        public static readonly MiseOrderGameId JSLH = new MiseOrderGameId()
        {
            Value = "74",
            OrderSubType = MiseOrderSubType.JSLH,
            Product = PlatformProduct.Lottery,
            SubGameCodeType = ThirdPartySubGameCodes.LotteryJSLH,
        ...
        public static readonly MiseOrderGameId CQ9Slot = new MiseOrderGameId()
        {
            Value = "cq9slot",
            OrderSubType = MiseOrderSubType.CQ9Slot,
            Product = PlatformProduct.CQ9SL,
            SubGameCodeType = ThirdPartySubGameCodes.CQ9Slot,
            ResourcePropertyName = nameof(PlatformProductElement.CQ9Slot),
        };

        /// <summary>CQ9电子</summary>
        public static readonly MiseOrderGameId CQ9Table = new MiseOrderGameId()
        {
            Value = "cq9table",
            OrderSubType = MiseOrderSubType.CQ9Table,
            Product = PlatformProduct.CQ9SL,
            SubGameCodeType = ThirdPartySubGameCodes.CQ9Table,
            ResourcePropertyName = nameof(PlatformProductElement.CQ9Table),
        };

        /// <summary>CQ9电子</summary>
        public static readonly MiseOrderGameId CQ9Fish = new MiseOrderGameId()
        {
            Value = "cq9fish",
            OrderSubType = MiseOrderSubType.CQ9Fish,
            Product = PlatformProduct.CQ9SL,
            SubGameCodeType = ThirdPartySubGameCodes.CQ9Fish,
