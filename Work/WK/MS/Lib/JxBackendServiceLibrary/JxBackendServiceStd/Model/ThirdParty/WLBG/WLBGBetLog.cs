...
namespace JxBackendService.Model.ThirdParty.WLBG
{
    ...
    public class WLBGCategory : BaseStringValueModel<WLBGCategory>
    {
        private WLBGCategory()
        { }

        public bool HasPartialRecord { get; private set; }

        public static readonly WLBGCategory Fish = new WLBGCategory()
        {
            Value = "1",
        };

        public static readonly WLBGCategory Live = new WLBGCategory()
        {
            Value = "2",
        };

        public static readonly WLBGCategory BoardGame = new WLBGCategory()
        {
            Value = "3",
        };

        public static readonly WLBGCategory Slot = new WLBGCategory()
        {
            Value = "4",
        };

        public static readonly WLBGCategory Sport = new WLBGCategory()
        {
            Value = "5",
            HasPartialRecord = true,
        };

        public static readonly WLBGCategory Lottery = new WLBGCategory()
        {
            Value = "6",
            HasPartialRecord = true,
        };
