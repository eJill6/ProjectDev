...
namespace JxBackendService.Service
{
    public class RecycleBalanceService : BaseBackSideService, IRecycleBalanceService
    {
        ...
        {
            BaseReturnModel baseReturnModel = _tpGameTransferOutService.Value.AllAmountByAllProductsWithMQToClient(
                    invocationUserParam,
                    routingSetting);
        ...
        {
            BaseReturnModel baseReturnModel = _tpGameTransferOutService.Value.AllAmountBySingleProductQueue(
                invocationUserParam,
                product,
                routingSetting);
