...
namespace JxBackendService.Service.Enums.MSL
{
    ...
    public class PlatformProductLotterySettingMSLService : BasePlatformProductSettingMSLService
    {
        public override bool IsParseUserIdFromSuffix => throw new PlatformNotSupportedException();
    }
}