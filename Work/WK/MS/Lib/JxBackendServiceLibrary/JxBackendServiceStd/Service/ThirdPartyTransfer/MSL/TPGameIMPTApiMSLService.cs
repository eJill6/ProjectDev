...
{
    public class TPGameIMPTApiMSLService : TPGameIMPTApiService
    {
        public TPGameIMPTApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
