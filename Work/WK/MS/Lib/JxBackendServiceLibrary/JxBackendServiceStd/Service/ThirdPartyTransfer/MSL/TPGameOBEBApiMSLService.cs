...
{
    public class TPGameOBEBApiMSLService : TPGameOBEBApiService
    {
        public TPGameOBEBApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
