...
namespace JxBackendService.Service.ThirdPartyTransfer
{
    public abstract class TPGameIMOneApiService : BaseTPGameApiService
    {
        ...
        protected readonly Lazy<IGameAppSettingService> _gameAppSettingService;
    ...
    public abstract class TPGameIMLotteryApiService : TPGameIMOneApiService
    {
        ...
        {
            return _jxCacheService.Value.GetCache(CacheKey.LotteryInfo, false, () =>
            {
                List<LotteryInfo> lotteryInfos = _lotteryInfoRep.Value.GetAll();
