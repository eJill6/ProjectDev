...
{
    public class TPGamePMBGApiMSLService : TPGamePMBGApiService
    {
        public TPGamePMBGApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
