...
namespace JxBackendService.Service.Setting
{
    ...
    {
        private readonly Lazy<IRefreshFrequencySettingRep> _refreshFrequencySettingRep;
        ...
        public BaseReturnModel SaveRefreshFrequencySetting(SaveRefreshFrequencySettingParam settingParm)
        {
            ...
            if (source == null)
            {
                return _refreshFrequencySettingRep.Value.CreateByProcedure(target).CastByJson<BaseReturnModel>();
            }

            bool isSuccess = _refreshFrequencySettingRep.Value.UpdateByProcedure(target);
        ...
        private RefreshFrequencySetting GetRefreshFrequencySettingByUser(string permissionKey)
        {
            ...
            return _refreshFrequencySettingRep.Value.GetSingleByKey(InlodbType.Inlodb,
