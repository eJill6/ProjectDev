...
{
    public class AmazonS3SettingService : BaseEnvLoginUserService, IOSSSettingService
    {
        ...
        public AmazonS3SettingService(EnvironmentUser envLoginUser) : base(envLoginUser)
        {
        }
