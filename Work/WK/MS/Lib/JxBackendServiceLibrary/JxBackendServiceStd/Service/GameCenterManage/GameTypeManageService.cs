...
namespace JxBackendService.Service.GameCenterManage
{
    public class GameTypeManageService : BaseGameCenterManageService, IGameTypeManageService
    {
        ...
        {
            FrontsideMenuType originModel = _frontsideMenuTypeRep.Value.GetSingleByKey(InlodbType.Inlodb, new FrontsideMenuType { Id = updateParam.No });
            ...
            bool isSuccess = _frontsideMenuTypeRep.Value.UpdateByProcedure(newModel);
