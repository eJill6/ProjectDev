...
namespace JxBackendService.Service
{
    ...
    {
        private readonly Lazy<IFrontsideMenuTypeRep> _frontsideMenuTypeRep;
        ...
        {
            List<FrontsideMenuType> entities = _frontsideMenuTypeRep.Value.GetAll();
        ...
        public List<JxBackendSelectListItem> GetLiveGameTabTypesSelectListItems(bool hasBlankOption, string defaultValue, string defaultDisplayText)
        {
            var frontsideMenuTypeSettings = new List<FrontsideMenuTypeSetting>
            {
                FrontsideMenuTypeSetting.Hot
            };

            return FrontsideMenuTypeSetting.GetSelectListItems(frontsideMenuTypeSettings, hasBlankOption, defaultValue, defaultDisplayText);
        }
