...
namespace JxBackendService.Repository.Extensions
{
    public static partial class DapperSqlMapperExtensions
    {
        ...
        public static long SaveByProcedure<T>(this IDbConnection connection, InlodbType inlodbType, ActTypes actType, T model) where T : class
        {
            return connection.SaveByProcedure(inlodbType, actType, tableName: null, model);
        }

        public static long SaveByProcedure<T>(this IDbConnection connection, InlodbType inlodbType, ActTypes actType, string tableName, T model) where T : class
        {
            ...
            string procedureName = GetProcedureName(inlodbType, actType, tableName);
        ...
        private static string GetProcedureName(InlodbType inlodbType, ActTypes actType, string tableName)
        {
            string actName;
            ...
            string fullProcedureName =  $"[Pro_{actName}SingleRowTo{tableName}]";


            if (inlodbType != null)
            {
                fullProcedureName = $"{inlodbType.Value}.dbo.{fullProcedureName}";
            }

            return fullProcedureName;
        }
