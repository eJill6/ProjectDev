...
namespace JxBackendService.Repository.StoredProcedure
{
    ...
    {
        private readonly Lazy<IProfitLossTypeNameService> _profitLossTypeNameService;
        ...
        public override string MoneyInInfoTableName => throw new NotImplementedException();

        public override string MoneyOutInfoTableName => throw new NotImplementedException();
        ...
        public override List<SqlSelectColumnInfo> PlayInfoSelectColumnInfos
        {
            get
            {
                ...
                HashSet<string> palyInfoColumnSet = ModelUtil.GetAllColumnInfos<PalyInfo>().Select(s => s.ColumnName).ConvertToHashSet();
        ...
        protected override string GetProfitLossTypeFilter(string profitLossType)
        {
            ...
            {
                ProfitLossTypeName commissionTypeName = _profitLossTypeNameService.Value.GetSingle(ProfitLossTypeName.Commission.Value);
            ...
            ProfitLossTypeName profitLossTypeName = _profitLossTypeNameService.Value.GetSingle(profitLossType);
