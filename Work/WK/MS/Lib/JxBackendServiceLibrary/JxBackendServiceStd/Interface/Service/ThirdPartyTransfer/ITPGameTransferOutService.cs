...
namespace JxBackendService.Interface.Service.ThirdPartyTransfer
{
    public interface ITPGameTransferOutService
    {
        ...
        BaseReturnModel AllAmountBySingleProduct(PlatformProduct product, IInvocationUserParam invocationUserParam);

        BaseReturnModel AllAmountBySingleProduct(PlatformProduct product, IInvocationUserParam invocationUserParam, out decimal actuallyAmount, out string moneyId);
