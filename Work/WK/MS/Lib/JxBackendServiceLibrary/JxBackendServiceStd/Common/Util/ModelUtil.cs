...
namespace JxBackendService.Common.Util
{
    public static class ModelUtil
    {
        ...
        public static List<PropertyInfo> KeyPropertiesCache(Type type)
        {
            ...
            var keyProperties = allProperties.Where(p => p.GetCustomAttributes(true).Any(a => a is IdentityKeyAttribute)).ToList();
        ...
        public static object GetModelValue(this object model, string propertyName)
        {
            if (model == null)
            {
                return null;
