...
namespace JxBackendService.Common.Util
{
    public static class DateTimeUtil
    {
        ...
        public static string ToRFC3339DateTimeFormatString(this DateTimeOffset dateTimeOffset, TimeSpan timeZoneOffset)
        {
            DateTimeOffset apiDateTime = dateTimeOffset.ToOffset(timeZoneOffset);
            string formattedString = apiDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fffK");
