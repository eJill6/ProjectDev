    ...
    public static class IpUtil
    {
        ...
        public static string GetDoWorkIP()
        {
            ...
            try
            {
                ...
                {
                    LogUtil.Error($"GetDoWorkIP errMessage:{errMessage}");
                }
            }
            catch (Exception ex)
            {
        ...
        private static IPContext_Model CreateIPContextModel()
        {
            return new IPContext_Model()
            {
                HTTP_X_FORWARDED_FOR = HttpContext.Current.Request.ServerVariables["X-Forwarded-For"],
                Proxy_Client_IP = HttpContext.Current.Request.Headers["Proxy-Client-IP"],
                WL_Proxy_Client_IP = HttpContext.Current.Request.Headers["WL-Proxy-Client-IP"],
                HTTP_CLIENT_IP = HttpContext.Current.Request.Headers["HTTP_CLIENT_IP"],
                X_Real_IP = HttpContext.Current.Request.Headers["X-Real-IP"],
