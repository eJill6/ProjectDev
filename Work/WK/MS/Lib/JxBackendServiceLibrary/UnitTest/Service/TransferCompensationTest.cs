...
namespace UnitTest.Util
{
    ...
    public class TransferCompensationTest : BaseTest
    {
        ...
        public void TestSaveMoneyOutCompensation()
        {
            ...
            {
                result = _transferCompensationService.Value.SaveMoneyOutCompensation(new SaveCompensationParam
                {
        ...
        {
            BaseReturnModel result = _transferCompensationService.Value.ProcessedMoneyOutCompensation(new ProcessedCompensationParam
            {
                UserID = 6253,
        ...
        {
            List<int> userIds = _transferCompensationService.Value.GetTransferCompensationUserIds(PlatformProduct.WLBG);
        }
    }
}