...
namespace JxBackendService.Model.Enums
{
    ...
    public class BaseValueModel<ValueType, T>
    {
        ...
        public static List<T> GetAll()
        {
            ...
            list = ReflectUtil.GetAllFields<T>().OrderBy(o => o.GetType().GetProperty(nameof(Sort))).ToList();
        ...
        public static List<JxBackendSelectListItem> GetSelectListItems(List<T> list, bool hasBlankOption, string defaultValue, string defaultDisplayText)
        {
            ...
            {
                Type type = f.GetType();
                string value = type.GetProperty("Value").GetValue(f, null).ToString();
                string text = type.GetProperty("Name").GetValue(f, null).ToString();
                selectListItems.Add(new JxBackendSelectListItem(value, text));
            });
