...
namespace JxBackendService.Common.Util
{
    public static class DateTimeUtil
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DateTime GetBeforeOneWeekDay()
        {
        ...
        /// 回傳Unix Time
        /// </summary>
        public static long ToUnixOfTime(this DateTime dateTime)
        {
        ...
        /// <summary>
        /// 傳入 字串 yyyyMMdd 時間格式 轉換成 DateTime
        /// </summary>
        /// <param name="yyyyMMdd"></param>
        /// <returns></returns>
        public static DateTime ToDateTime(this string yyyyMMdd)
        {
            if (yyyyMMdd.IsNullOrEmpty())
            {
                return DateTime.Now;
            }

            return DateTime.ParseExact(yyyyMMdd, "yyyyMMdd", null, DateTimeStyles.AllowWhiteSpaces);
        }
