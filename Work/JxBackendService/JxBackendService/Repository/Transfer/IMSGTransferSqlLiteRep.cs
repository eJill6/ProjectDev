...
{
    public class IMSGTransferSqlLiteRep : BaseTransferSqlLiteRepository<IMLotteryBetLog>
    {
        public IMSGTransferSqlLiteRep() { }

        public override PlatformProduct Product => PlatformProduct.IMSG;

        public override string ProfitlossTableName => "IMSGProfitLossInfo";
