...
{
    public class TPGameBTISApiMockService : TPGameBTISApiService
    {
        public TPGameBTISApiMockService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
