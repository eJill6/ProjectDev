...
namespace JxBackendService.Service.Enums
{
    public class BaseValueModelService<ValueType, T> : IBaseValueModelService<ValueType, T>
    {
        ...
        public string GetName(ValueType value)
        {
        ...
        {
            return BaseValueModel<ValueType, T>.GetSelectListItems(list, hasBlankOption);
        }
        ...
        {
            return BaseValueModel<ValueType, T>.GetSelectListItems(list, hasBlankOption, defaultValue, defaultDisplayText);
        }
