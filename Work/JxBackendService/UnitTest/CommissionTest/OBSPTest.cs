...
{
    [TestClass]
    public class OBSPTest : MainTest
    {
        private readonly PlatformProduct _product = PlatformProduct.OBSP;

        private readonly PlatformProduct _secondProduct = PlatformProduct.IMSport;
        ...
        {
            DateTime startDate = DateTime.Parse($"2021/06/01");
            DateTime endDate = DateTime.Parse($"2021/06/01");
