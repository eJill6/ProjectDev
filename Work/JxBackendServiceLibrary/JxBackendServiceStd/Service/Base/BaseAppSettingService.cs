...
namespace JxBackendService.Service.Base
{
    public abstract class BaseAppSettingService : IAppSettingService
    {
        ...
        private IConfigUtilService _configUtilService;

        public IConfigUtilService ConfigUtilService
        {
            get
            {
                ...
                return _configUtilService;
            }

            set
            {
                //初始化的時候因為有可能還沒有DI初始化完成,這邊開放configService的實作指定
                _configUtilService = value;
            }
        }
