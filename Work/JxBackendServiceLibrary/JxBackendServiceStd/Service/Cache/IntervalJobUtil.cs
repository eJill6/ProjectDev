...
namespace JxBackendService.Service.Cache
{
    public static class IntervalJobUtil
    {
        ...
        private static void SetCacheForInterval(this IJxCacheService jxCacheService, CacheKey cacheKey, double cacheSeconds, IntervalCacheResult currentResult, bool isNormalTry)
        {
            if (currentResult == null)
            {
