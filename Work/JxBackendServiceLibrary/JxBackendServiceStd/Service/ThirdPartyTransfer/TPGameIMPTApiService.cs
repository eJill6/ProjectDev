...
{
    public abstract class TPGameIMPTApiService : TPGameIMOneApiService
    {
        ...
        public override IIMOneAppSetting AppSetting => _gameAppSettingService.GetIMPTAppSetting();
    }

    [MockService]
    public class TPGameIMPTApiMockService : ITPGameApiService, ITPGameApiReadService
    {
        public PlatformProduct Product => PlatformProduct.IMPT;

        public bool IsBackupBetLog => throw new NotImplementedException();
