...
namespace JxBackendService.Service.ThirdPartyTransfer.Old
{
    ...
    {
        private readonly IBetLogFileService _betLogFileService;
        ...
        protected abstract bool IsBackupBetLog { get; }
        ...
        protected IBetLogFileService BetLogFileService => _betLogFileService;

        protected IConfigUtilService ConfigUtilService { get; private set; }
        ...
        public BaseBetDetailService()
        {
            ...
            ConfigUtilService = DependencyUtil.ResolveService<IConfigUtilService>();
            ...
            if (result != null)
            {
                ...
                if (IsBackupBetLog)
                {
                    ...
                    result.WriteRemoteContentToOtherMerchant = () =>
                    {
                        ...
                        _betLogFileService.WriteRemoteContentToOtherMerchant(Product, fileSeq, content, service.CopyBetLogToMerchantCodes);
                    };
                }
            }
        ...
        {
            BaseReturnDataModel<RequestAndResponse> requestReturnModel = _tpGameApiService.GetRemoteBetLog(param.LastSearchToken);
