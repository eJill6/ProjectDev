...
{
    public class TPGameIMeBETApiMSLService : TPGameIMeBETApiService
    {
        public TPGameIMeBETApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
