...
{
    public class TPGamePGSLApiMSLService : TPGamePGSLApiService
    {
        public TPGamePGSLApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
