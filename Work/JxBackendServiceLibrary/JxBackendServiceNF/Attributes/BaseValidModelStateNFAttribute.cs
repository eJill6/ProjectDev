...
{
    public abstract class BaseValidModelStateNFAttribute : ActionFilterAttribute
    {
        private readonly int? _httpStatusCode;

        public BaseValidModelStateNFAttribute()
        {
        }

        public BaseValidModelStateNFAttribute(HttpStatusCode httpStatusCode)
        {
