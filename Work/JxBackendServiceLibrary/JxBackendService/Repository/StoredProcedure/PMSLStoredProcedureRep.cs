...
namespace JxBackendService.Repository.StoredProcedure
{
    public class PMSLStoredProcedureRep : BaseTPGameStoredProcedureRep
    {
        ...
        protected override string MoneyInInfoTableName => "PMSLMoneyInInfo";

        protected override string MoneyOutInfoTableName => "PMSLMoneyOutInfo";
        ...
        protected override string AddProfitlossAndPlayInfoSpName => "Pro_AddPMSLProfitLossAndPlayInfo";
