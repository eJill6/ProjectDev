...
namespace JxBackendService.Repository.StoredProcedure
{
    public class PMBGStoredProcedureRep : BaseTPGameStoredProcedureRep
    {
        ...
        protected override string MoneyInInfoTableName => "PMBGMoneyInInfo";

        protected override string MoneyOutInfoTableName => "PMBGMoneyOutInfo";
        ...
        protected override string AddProfitlossAndPlayInfoSpName => "Pro_AddPMBGProfitLossAndPlayInfo";
