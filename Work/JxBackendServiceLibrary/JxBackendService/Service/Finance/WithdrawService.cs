...
namespace JxBackendService.Service.Finance
{
    public class WithdrawService : BaseService, IWithdrawService
    {
        ...
        public BaseReturnModel WithdrawToMiseLive(decimal amount)
        {
            ...
            BaseReturnDataModel<BasicCMoneyOutInfo> returnDataModel = CreateProcessingCMoneyOut(userId, amount);
        ...
        private BaseReturnDataModel<BasicCMoneyOutInfo> CreateProcessingCMoneyOut(int userId, decimal amount)
        {
