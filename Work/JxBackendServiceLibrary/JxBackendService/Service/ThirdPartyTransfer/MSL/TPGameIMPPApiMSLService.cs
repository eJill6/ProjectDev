...
{
    public class TPGameIMPPApiMSLService : TPGameIMPPApiService
    {
        public TPGameIMPPApiMSLService(EnvironmentUser envLoginUser, DbConnectionTypes dbConnectionType) : base(envLoginUser, dbConnectionType)
        {
        }
