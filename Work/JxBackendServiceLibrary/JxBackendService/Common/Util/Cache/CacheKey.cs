...
using JxBackendService.Model.HomeGameMenu;
...
namespace JxBackendService.Common.Util.Cache
{
    ...
    public class CacheKey : BaseStringValueModel<CacheKey>
    {
        ...
        public static CacheKey GetFrontSideUserInfoKey(string userKey) => new CacheKey(CacheTypes.LocalAndCacheServer, $"WEB#WebUserToken:{userKey}")
        {
            IsFormatKey = false,
            IsDoSerialize = false
        };
